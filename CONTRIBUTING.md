...
- **Node 8 LTS:** `generator-codebuild` has a minimum Node version
...
``` bash
git clone https://github.com/EndemolShineGroup/generator-codebuild.git
cd generator-codebuild
yarn
yarn test
```
...
We want to ensure that `generator-codebuild` is secure for everyone. If
